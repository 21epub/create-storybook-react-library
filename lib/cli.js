...
module.exports = async () => {
  ...
  program
    .name('create-storybook-react-library')
    .version(version)
    ...
    .option(
      '-t, --template <storybook-ts-react|storybook-ts-antd>',
      'package template to use',
      /^(storybook-ts-react|storybook-ts-antd)$/,
      defaults.template
    )
...
And then you can develop your module code in ./src 
`)
